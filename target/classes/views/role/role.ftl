...
<form class="layui-form" >
    <blockquote class="layui-elem-quote quoteBox">
        <form class="layui-form">
            <div class="layui-inline">
                ...
                </div> <a class="layui-btn search_btn" data-type="reload">
    ...
    <script id="roleListBar" type="text/html">
        <a class="layui-btn layui-btn-xs" id="edit" lay-event="edit">
            编辑
        </a>
...
<script type="text/javascript" src="${ctx}/js/role/role.js">
</script>
</body>
</html>
